...
export interface ApiAccessoryAccessory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Reusable accessories that can be linked to products';
  ...
  attributes: {
    compatible_products: Schema.Attribute.Relation<
      'manyToMany',
      'api::product.product'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiAlongCarePageAlongCarePage extends Struct.SingleTypeSchema {
  collectionName: 'along_care_page';
  info: {
    description: 'Along Care page content with title, description, and markdown';
    displayName: 'Along Care Page';
    pluralName: 'along-care-pages';
    singularName: 'along-care-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::along-care-page.along-care-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog model for store blog posts with title, content, author, featured image, and publication date';
    displayName: 'Blog';
    pluralName: 'blogs';
    singularName: 'blog';
  };
...
export interface ApiOrderItemOrderItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Items inside an order (bike or accessory)';
  ...
  attributes: {
    accessory: Schema.Attribute.Relation<
      'manyToOne',
      'api::accessory.accessory'
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    item_type: Schema.Attribute.Enumeration<['bike', 'accessory']> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Customer order with Stripe payment tracking';
    displayName: 'Order';
    pluralName: 'orders';
    singularName: 'order';
  };
  ...
  attributes: {
    agreed_to_terms: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    customer_country: Schema.Attribute.String;
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Business partners information';
    displayName: 'Partner';
    pluralName: 'partners';
...
export interface ApiPrivacyPolicyPagePrivacyPolicyPage
  ...
  info: {
    description: 'Privacy Policy page content with title, description, and markdown';
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Bike product with specs, colors, accessories, and markdown details';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    available_accessories: Schema.Attribute.Relation<
      'manyToMany',
      'api::accessory.accessory'
    >;
    category: Schema.Attribute.Enumeration<['bike']> &
      Schema.Attribute.DefaultTo<'bike'>;
    colors: Schema.Attribute.Component<'product.color-option', true>;
...
export interface ApiSectionOneSectionOne extends Struct.CollectionTypeSchema {
...
export interface ApiShippingReturnsPageShippingReturnsPage
  extends Struct.SingleTypeSchema {
  collectionName: 'shipping_returns_page';
  info: {
    description: 'Shipping and Returns page content with title, description, and markdown';
    displayName: 'Shipping and Returns Page';
    pluralName: 'shipping-returns-pages';
    singularName: 'shipping-returns-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::shipping-returns-page.shipping-returns-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiTermsConditionsPageTermsConditionsPage
  ...
  info: {
    description: 'Terms and Conditions page content with title, description, and markdown';
...
export interface ApiWarrantyPageWarrantyPage extends Struct.SingleTypeSchema {
  collectionName: 'warranty_page';
  info: {
    description: 'Warranty page content with title, description, and markdown';
